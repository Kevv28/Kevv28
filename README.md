...
### **Outlier AI**  
**Data Annotator / AI Prompt Engineer (Part-Time)**  
*Sep 2024 – Sep 2025*
...
### **SelfVCS**  
*Python, FastAPI, Groq API, Click CLI*

- Developed a lightweight, local version control system enhanced with AI for automated commit insights and changelog generation.
- Built secure, local commit storage to ensure privacy without cloud infrastructure.
- Designed a CLI supporting push, log, restore, and versioning commands.

---

### **AI-Agent Call**  
*ElevenLabs, Twilio API, Express.js, WebSockets*

- Developed an AI-powered voice agent system using ElevenLabs API for real-time voice synthesis.
- Integrated WebSockets for low-latency, bidirectional communication.
- Optimized the system to handle 1,000+ concurrent real-time connections.
